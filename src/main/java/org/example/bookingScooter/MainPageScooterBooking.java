...
public class MainPageScooterBooking {//главная страница где лежит FAQ и кнопки Заказать
    ...
    //поле isbookingButtonUp используется в методе public void clickBookingButton(boolean isbookingButtonUp) {//метод для определения через какую кнопку сделать заказ Верх или низ (строчка 23)
